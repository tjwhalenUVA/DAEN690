...
print('\nKMeans Clustering: Setting global path variables')
directory = os.path.dirname('__file__')
input_file = os.path.join(directory, '..', 'script_output')
output = os.path.join(directory, '..', 'script_output')
output_km = os.path.join(directory, '..', 'script_output', 'kmeans')
kmeansInertias_csv = os.path.join(directory, '..', 'script_output',
                                  'kmeansInertias.csv')
resume_KvsSSE_png = os.path.join(directory, '..', 'script_output',
                                 'resume_KvsSSE.png')
tfidf_hist_png = os.path.join(directory, '..', 'script_output',
                              'tfidf_hist.png')

# %%
# Ingest conditioned resumes file from script 03.

print('\nKMeans Clustering: Read in conditioned resumes from file ',
...
print('\nKMeans Clustering: The file being read in is: ', latest_file)
...
vz = vectorizer.fit_transform(list(resumes_df['Resumes']))
