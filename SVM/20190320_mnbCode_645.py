...
_df['bias_three'] = _df['bias_final'].replace('left-center','least')
_df['bias_three'] = _df['bias_three'].replace('right-center','least')

test_df['bias_three'] = test_df['bias_final'].replace('left-center','least')
test_df['bias_three'] = test_df['bias_three'].replace('right-center','least')
